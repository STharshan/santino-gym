      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-white">
              All content on this website (including text, images, graphics, and logos) is owned by or licensed to Santino&apos;s Gym & Studio. You may view, download, and print content for personal use only. You must not copy, reproduce, or distribute our website content without prior written consent.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="text-white">
              <p><strong>{`Santino's Gym & Studio`}</strong></p>

              <p>Email: <a href="mailto:info@santinosgym.com" className="text-red-500 hover:underline">info@santinosgym.com</a></p>
              <p>Phone: +44 7565 603231</p>
